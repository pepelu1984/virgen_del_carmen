...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
	...
	<input type="hidden" id="ideducador" name="ideducador" value="<%=ideducador%>">
		...
		<table width="90%" style="background-color:ffffff; margin-left:80px">
		 <tr>
				 <td>Curso a consultar<br>
				 		<select width="300" style="width: 300px" id="slCursos" name="slCursos" onchange="javascript:searchAlergias();searchAlumnosByCurso5()">							
							<option value="Seleccione un registro">Seleccione el curso que desea consultar</option>								
							<%
