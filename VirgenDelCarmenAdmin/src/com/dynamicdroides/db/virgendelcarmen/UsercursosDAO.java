...
/**
 	* A data access object (DAO) providing persistence and search support for Usercursos entities.
...
public class UsercursosDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(UsercursosDAO.class);
		//property constants
    ...
    public Usercursos findById( java.lang.Integer id) {
        ...
        try {
            Usercursos instance = (Usercursos) getSession()
                    .get("com.dynamicdroides.db.virgendelcarmen.Usercursos", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Usercursos instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.dynamicdroides.db.virgendelcarmen.Usercursos")
    ...
    public Usercursos merge(Usercursos detachedInstance) {
        ...
        try {
            Usercursos result = (Usercursos) getSession()
