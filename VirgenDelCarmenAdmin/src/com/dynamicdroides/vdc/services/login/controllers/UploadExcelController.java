...
public class UploadExcelController   extends IControlador{
	...
	//private static String pathToExcels="C://Pruebas/";
	...
	private VirgenDelCarmenBusiness business;
		...
		public void processRequest(HttpServletRequest request) throws Exception{
			...
			if(isMultipart){
				...
				uploadExceltoDatabase(pathToExcels, fileName, Integer.parseInt(idCurso));
		...
		public boolean uploadExceltoDatabase(String path,String name,int idCurso) throws IOException{
			
			return reader.readAndSaveAll(path, name,idCurso);
