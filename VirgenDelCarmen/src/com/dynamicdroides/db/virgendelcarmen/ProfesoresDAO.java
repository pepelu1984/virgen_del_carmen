 ...
 * Profesores entities. Transaction control of the save(), update() and delete()
 * operations can directly support Spring container-managed transactions or they
 * can be augmented to handle user-managed Spring transactions. Each of these
 * methods provides additional information for how to configure it for the
 * desired type of transaction control.
 * 
 * @see com.dynamicdroides.db.virgendelcarmen.Profesores
 * @author MyEclipse Persistence Tools
 */
public class ProfesoresDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(ProfesoresDAO.class);
	// property constants
	...
	public void save(Profesores transientInstance) {
	...
	public Profesores findById(java.lang.Integer id) {
		...
		try {
			Profesores instance = (Profesores) getSession().get(
					"com.dynamicdroides.db.virgendelcarmen.Profesores", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Profesores instance) {
		log.debug("finding Profesores instance by example");
		try {
			List results = getSession()
					.createCriteria(
							"com.dynamicdroides.db.virgendelcarmen.Profesores")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Profesores instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Profesores as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		...
		try {
			String queryString = "from Profesores";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Profesores merge(Profesores detachedInstance) {
		...
		try {
			Profesores result = (Profesores) getSession().merge(
					detachedInstance);
