 ...
 * Usuariosalumnos entities. Transaction control of the save(), update() and
...
public class UsuariosalumnosDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(UsuariosalumnosDAO.class);
	// property constants
	...
	public Usuariosalumnos findById(java.lang.Integer id) {
		...
		try {
			Usuariosalumnos instance = (Usuariosalumnos) getSession()
					.get("com.dynamicdroides.db.virgendelcarmen.Usuariosalumnos",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Usuariosalumnos instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"com.dynamicdroides.db.virgendelcarmen.Usuariosalumnos")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Usuariosalumnos instance with property: "
	...
	public Usuariosalumnos merge(Usuariosalumnos detachedInstance) {
		...
		try {
			Usuariosalumnos result = (Usuariosalumnos) getSession().merge(
					detachedInstance);
